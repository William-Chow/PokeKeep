package com.william.pokekeep.app.base;
...
import static me.jessyan.art.base.BaseActivity.setWindowFlag;
 ...
 * @param <P>
 */
public abstract class SwipeBackBaseActivity<P extends IPresenter> extends SwipeBackActivity implements IActivity<P>, ActivityLifecycleable {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        try {
            ...
            if (layoutResID != 0) {
                ...
                // Full Screen
                if (TAG.equalsIgnoreCase("MainActivity") || TAG.equalsIgnoreCase("ProfileActivity") || TAG.equalsIgnoreCase("WelcomeActivity") || TAG.equalsIgnoreCase("LoginActivity")) {
